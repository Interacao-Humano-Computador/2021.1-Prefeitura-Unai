...
<p align="justify">
O site da Prefeitura de Ponta Grossa apresenta informações, ouvidoria, links úteis e serviços de útilidade pública, de saúde e da Secretaria da Fazenda.
</p>
<br>
<p align="justify">
Segundo a avaliação do site, os dois principais problemas de usabilidade são a <strong>poluição visual</strong> e a <strong>responsividade</strong>. Na página inicial, é nítida a quantidade de informações que não fazem parte de um mesmo contexto em um pequeno espaço, dificultando ao usuário encontrar o que deseja. Outro ponto é que a responsividade não é boa, o site gera um desconforto ao usuário por não se adaptar a dispositivos móveis ou com telas menores.
</p>
<br></br>
...
| 15/08/2021 | 1.0 | Adição de conteúdo    | Hugo Rocha | 
